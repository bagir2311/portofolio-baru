...
const projects = [
  {
    id: "1",
    title: {
      id: "Aplikasi PARKIRAJA",
      en: "PARKIRAJA App",
    },
    description: {
      id: "Aplikasi pencari parkir onlen.",
      en: "Online parking finder app.",
    },
  ...
  },
  {
    ...
    description: {
      id: "Website pribadi untuk menampilkan karya dan kontak.",
      en: "Personal website to showcase work and contact info.",
    },
  ...
  },
  {
    ...
    description: {
      id: "Website untuk PARKIRAJA.",
      en: "Website for PARKIRAJA.",
    },
...
function ProjectsScreen(): React.ReactElement {
  const navigation =
  ...
  const { language = "id" } = (route.params || {}) as { language: "id" | "en" };
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <View style={styles.textContainer}>
              <Text
                style={[styles.title, { color: isDark ? "#FBBF24" : "#1E3A8A" }]}
              >
                {item.title[language]}
              </Text>
              <Text
